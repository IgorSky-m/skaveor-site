...
public class OrderController {
    ...
    @PostMapping("/place")
    public PlacedOrderResponse placeOrder(@RequestBody OrderRequest request, @RequestHeader Map<String, String> headers) {
        return orderService.placeOrder(request, headers.getOrDefault("id", null));
    }
